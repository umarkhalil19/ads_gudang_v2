                ...
                <div class="components-preview">
                    <div class="nk-block-head nk-block-head-lg wide-sm">
                        <div class="nk-block-head-content">
                            <h2 class="nk-block-title fw-normal">Tambah Distributor</h2>
                        </div>
                    </div><!-- .nk-block-head -->
                        ...
                        <div class="nk-block-head">
                            <div class="nk-block-head-content">
                                <div class="nk-block-des">
                                    <p>Form ini digunakan untuk menambah data distributor</p>
                                </div>
                            </div>
                        </div>
                        <div class="card card-preview">
                            <div class="card-inner">
                                <div class="preview-block">
                                    <span class="preview-title-lg overline-title">Form Tambah Distributor</span>
                                    <?php echo form_open('distributor/distributor_add_act'); ?>
                                    <div class="row g-2">
                                        <div class="col-lg-12">
