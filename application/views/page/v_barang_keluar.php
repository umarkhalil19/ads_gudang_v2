                        ...
                        <table class="datatable-init table">
                            ...
                            <tbody>
                                ...
                                foreach ($barang_keluar->result() as $s) {
                                    ...
                                    $tn = $this->db->query("SELECT SUM(keluar_harga) AS harga, SUM(keluar_diskon) AS diskon FROM tbl_barang_keluar WHERE keluar_invoice='$s->invoice_kode'")->row();
                                ?>
                                    <tr>
                                        <td><?= $no++; ?></td>
