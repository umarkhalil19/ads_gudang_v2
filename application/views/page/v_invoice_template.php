...
foreach ($barang->result() as $b) {
    ...
    $h_satuan = ($b->keluar_harga + $b->keluar_diskon) / $b->keluar_jumlah;
    $total_keluar = $total_keluar + ($b->keluar_jumlah * $h_satuan);
                    ...
                    ?>
                        <div class="row">
                            ...
                            <div class="col-md-4 offset-md-2" style="padding: 20px;">
                                <table>
                                    <tr>
                                        <td style="width: 100px;font-size:14px;font-weight:bold;">INVOICE #</td>
                                        <td style="font-size: 14px;font-weight:bold;">:</td>
                                        <td style="font-size: 14px;font-weight:bold;"><?= $invoice->invoice_kode ?></td>
                                    </tr>
                                    <tr>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td style="font-size:small;"><?= $nama->barang_nama; ?></td>
                                    ...
                                    <?php } else { ?>
                                        <tr style="color: red;">
                                            <td style="font-size:medium;"><?= $no++ ?></td>
                                            <td style="font-size:small;">Barang Di Hapus Dari Master</td>
                                            <td style="font-size:medium;"><?= $b->keluar_jumlah; ?></td>
                                            <td style="font-size:medium;">-</td>
                                            <td style="font-size:medium;"><?= _rupiah(($b->keluar_harga + $b->keluar_diskon) / $b->keluar_jumlah); ?></td>
                                            <td style="font-size:medium;"><?= _rupiah($b->keluar_diskon); ?></td>
                                            <td style="font-size:medium;"><?= _rupiah($b->keluar_harga + $b->keluar_diskon); ?></td>
                                            <?php
                                            $diskon = $diskon +  $b->keluar_diskon;
                                            ?>
                                        </tr>
                                ...
                                <?php if ($th == $total_page && $barang->num_rows() <= 6) { ?>
                                    <tr>
                                        <td colspan="2" style="text-align: right; font-size:medium;">Jumlah : </td>
                                        <td style="font-size:medium;"><b><?= $jumlah_brg; ?></b></td>
                                        <td colspan="4" style="text-align: right; font-size:18px;">Total : <?= _rupiah($total_keluar) ?></td>
                                        <!-- <td style="font-size:18px;"><b><?= _rupiah($total_keluar) ?></b></td> -->
                                    </tr>
                                    <tr>
                                        <td colspan="7" style="text-align: right; font-size:18px;">Diskon : <?= _rupiah($diskon) ?></td>
                                        <!-- <td style="font-size:18px;" class="float-left"><b><?= _rupiah($diskon) ?></b></td> -->
                                    </tr>
                                    <tr>
                                        <td colspan="7" style="text-align: right; font-size:18px;">NETT : <?= _rupiah($invoice->invoice_total_harga) ?></td>
                                        <!-- <td style="font-size:16px;"><b><?= _rupiah($invoice->invoice_total_harga) ?></b></td> -->
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                        <?php if ($th == $total_page && $barang->num_rows() > 6) { ?>
                            <?php if ($barang->num_rows() == 7) { ?>
                                <div style="margin-bottom:290px"></div>
                            <?php } elseif ($barang->num_rows() == 8) { ?>
                            ...
                            <div class="col-md-3" style="padding: 2px;">
                                <hr>
                                <p style="margin-top: -10px"><?= $toko->toko_nama ?></p>
                            </div>
                        <?php } elseif ($th == $total_page) { ?>
                            <div class="col-md-3" style="padding: 2px;">
                                <hr>
                                <p style="margin-top: -10px"><?= $toko->toko_nama ?></p>
                            </div>
