        ...
        <div class="nk-content-inner">
            <div class="nk-content-body">
                    ...
                    <div class="container mt-3 mb-3">
                        <div class="row g-2">
                            ...
                            <div class="col-lg-9">
                                <div class="form-group">
                                    <?php
                                    $tn = $this->db->query("SELECT SUM(keluar_harga) AS harga, SUM(keluar_diskon) AS diskon FROM tbl_barang_keluar WHERE keluar_invoice='$invoice->invoice_kode'")->row();
                                    $dibayar = $this->db->query("SELECT SUM(bon_dibayar) as total_bayar FROM tbl_bon_kredit WHERE kode_invoice='$invoice->invoice_kode'")->row();
                                    ?>
                                    <p class="form-label">: <?= _rupiah($tn->harga + $tn->diskon); ?></p>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <p class="form-label" for="jumlah">Diskon</p>
                                </div>
                            </div>
                            <div class="col-lg-9">
                                <div class="form-group">
                                    <p class="form-label">: <?= _rupiah($tn->diskon); ?></p>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <p class="form-label" for="jumlah">NETT</p>
                                </div>
                            </div>
                            <div class="col-lg-9">
                                <div class="form-group">
                                    <p class="form-label">: <?= _rupiah($tn->harga); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container mt-3 mb-3">
                        <table class="datatable-init table">
                            ...
                            <tbody>
                                ...
                                $no = 1;
                                $bayar = 0;
                                $total_transaksi = $tn->harga;
                                foreach ($bon->result() as $s) {
                                ?>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        <td><?= $s->kode_invoice; ?></td>
                                        <td><?= _rupiah($total_transaksi) ?></td>
                                ...
                                <?php
                                    $total_transaksi = $total_transaksi - $s->bon_dibayar;
                                    $bayar = $bayar + $s->bon_dibayar;
                                }
                                ?>
                            </tbody>
                        </table>
                ...
                <div class="card card-bordered card-full">
                    ...
                    <div class="container mt-3 mb-3">
                        <div class="row g-2">
                            <?php if ($bayar < $tn->harga) {
                                $bon_bayar = $bon->row(); ?>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-label" for="invoice">Sisa Bon</label>
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" name="total" id="total" autocomplete="off" value="<?= _rupiah($tn->harga - $dibayar->total_bayar) ?>" disabled>
                                            <!-- <input type="text" class="form-control" name="total" id="total" autocomplete="off" value="<?= _rupiah($bon_bayar->bon_total) ?>" disabled> -->
                                            <input type="hidden" class="form-control" name="total" id="total" autocomplete="off" value="<?= $tn->harga - $dibayar->total_bayar ?>">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-label" for="tgl">Tanggal Pembayaran</label>
                                        <div class="form-control-wrap">
