                                            ...
                                            <div class="row g-2">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <select name="kode" id="kode" class="showBarang form-select form-control" data-search="on" autofocus>
                                            ...
                                            <div class="row g-2">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" name="invoice" id="invoice" autocomplete="off" value="Di Generate Otomatis Oleh Sistem" disabled>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label class="form-label" for="tgl">Tanggal Keluar</label>
                                                        <div class="form-control-wrap">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <select name="toko" id="toko" class="form-select form-control" data-search="on">
                                                                <option value="default_option">Pilih Toko</option>
                                                                <?php
                                                                foreach ($toko->result() as $t) {
                                                                    echo '<option value="' . $t->toko_id . '">' . $t->toko_nama . ' / ' . $t->toko_alamat . '</option>';
                                                                }
                                                                ?>
                                                            </select>
