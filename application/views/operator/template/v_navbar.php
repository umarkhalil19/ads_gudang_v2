                    ...
                    <div class="nk-header-wrap">
                        ...
                        <div class="nk-header-menu" data-content="headerNav">
                            ...
                            <ul class="nk-menu nk-menu-main ui-s2">
                                ...
                                <li class="nk-menu-item has-sub">
                                    <a href="<?= base_url('Barang') ?>" class="nk-menu-link">
                                        <span class="nk-menu-text">Barang</span>
                                    </a>
                                </li>
                                <li class="nk-menu-item has-sub">
                                    <a href="<?= base_url('Barang_Masuk') ?>" class="nk-menu-link">
                                        <span class="nk-menu-text">Barang Masuk</span>
                                    </a>
                                </li>
                                <li class="nk-menu-item has-sub">
                                    <a href="<?= base_url('Barang_Keluar') ?>" class="nk-menu-link">
                                ...
                                <li class="dropdown user-dropdown order-sm-first">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-md dropdown-menu-right dropdown-menu-s1 is-light">
                                        ...
                                        <div class="dropdown-inner">
                                            <ul class="link-list">
                                                <li><a href="<?= base_url() ?>admin/change_pass"><em class="icon ni ni-lock-alt"></em><span>Ubah Password</span></a></li>
